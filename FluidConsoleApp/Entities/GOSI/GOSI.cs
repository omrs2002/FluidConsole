...
namespace FluidConsoleApp.Entities
{
    ...
    public class SbcEstablishmentSummaryResponseModel 
    {
        ...
        // this will be updated after mc created and before sending 
        public string CRNo { get; set; } = "00000";
        // this will be updated after mc created and before sending 
        public string NationalNo { get; set; } = "0000000000";
        ...
        public List<CRParty> CRParties { get; set; }
        public Nationality<string> Nationality { get; set; }
        public List<CRActivity<string>> CRActivities { get; set; }
        public GosiLocation Location { get; set; }
        public CRRepresentativeForGozi<string> CRRepresentative { get; set; }
        public City City { get; set; }


        [JsonIgnore]
        //public ClientServiceType[] Types { get; } = new[] { ClientServiceType.GOSI };
        #endregion
